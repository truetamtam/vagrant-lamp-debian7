...
# Install php5 further dependencies
%w{ php5-imap php5-mcrypt }.each do |a_package|
  package a_package
end

# Create PHP configuration libapache2-mod-php5
...
sites.each do |name|
  ...
  web_app site["host"] do
    ...
    docroot site["docroot"]?site["docroot"]:"/vagrant/"
  end  
...
# Setup MailCatcher
bash "mailcatcher" do
  code "sudo mailcatcher --http-ip #{eth1_ip} --smtp-port 25"
...
%w{ libmysqlclient18 percona-toolkit }.each do |a_package|
  package a_package
end
